...
class IndexPage extends React.Component {
  ...
  onSubmit = data => {
    ...
    this.setState(({ history: prevHistory }) => {
  ...
  setStorage = () => {
    ...
    localStorage.setItem(URL_HISTORY, JSON.stringify(history.slice(0, MAX_HISTORY)))
  }
  render() {
              ...
              <div className="mb4-l">
                ...
                {details.hash ? (
                  ...
                  <div className="mw6 pl3 f4-l f5 fw3 lh-copy light-gray">
                    <p className="mb2 pt2">
                      Shink down that absurdly long link. Add an optional duration time to limit how long your
                      link will work.
                    </p>
                    <p>You can also add a passcode to protect who can use your link.</p>
                  </div>
                )}
              </div>
            </div>
